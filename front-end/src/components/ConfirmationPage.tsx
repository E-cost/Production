...
const ConfirmationPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_API_HOST}:${process.env.REACT_APP_API_PORT}/contacts/confirmation?email_id=${emailId}&secret_code=${secretCode}`);
