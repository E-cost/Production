...
func GenerateRusPDF(
	...
	colWidths := []float64{10, 30, 45, 30, 20, 20, 20}
	...
	headersRUS := []string{"№", "Артикул", "Название", "Масса нетто", "Кол-во", "НДС", "Цена"}
	...
	for _, item := range newOrder.Items {
		...
		pdf.CellFormat(colWidths[5], 8, "20%", "1", 0, "C", false, 0, "")
		pdf.CellFormat(colWidths[6], 8, fmt.Sprintf("%.2f", item.PriceBYN), "1", 0, "C", false, 0, "")
		pdf.Ln(-1)
	}
