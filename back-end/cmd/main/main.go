...
func initializeServices(
	...
	*mail.YandexSender,
	...
	emailSvc := mail.NewYandexSender(cfg.Email)
	contactSvc := service1.NewContactService(logger, emailSvc, contacts, nil)
	...
	return contactSvc, itemSvc, orderSvc, yandexSvc, redisSvc, redisItemsSvc, emailSvc
}
...
func initializeHandlers(
	...
	contactHandler := contactsHandler.NewContactHandler(logger, ipMiddleware, emailSvc, contacts, yandexOrderFacade)
...
func main() {
	...
	contactSvc, itemSvc, orderSvc, yandexSvc, redisSvc, redisItemsSvc, emailSvc := initializeServices(logger, presignedClient, redisClient, cfg, contacts, items, orders)
	...
	initializeHandlers(logger, ipMiddleware, router, presignedClient, cfg, emailSvc, contacts, items, orders, redisItemsSvc, orderContactFacade, orderItemFacade, yandexItemFacade, yandexOrderFacade)
